...
import { ArrowLeft, Building2, Coins, DollarSign, Mail, Package, Phone, Store } from 'lucide-react'
import MetricCard from '../components/MetricCard'
import SeguimientoTimeline from '../components/portal/SeguimientoTimeline'
import { getItems, getSesiones } from '../api/packing'
...
// estado del envío (tracking/BL) sin ninguna acción de edición.
    ...
    <div className="flex flex-col gap-6">
      ...
      {cargando ? (
        ...
        <>
          ...
          {/* Estado del envío / tracking (solo lectura) */}
          <section className="card">
            <h2 className="mb-4" style={{ fontWeight: 700, fontSize: 18, color: '#0D0D0D' }}>
              {t('detalle.envio')}
            </h2>
